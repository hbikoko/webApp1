    ...
    <div className="story-container">
      ...
      <div className="board-members">
        ...
        <div className="board-member">
          <h2 className="member-name">{t('story.frieda.name', 'Frieda Bikele')}</h2>
          <h3 className="member-title">{t('story.frieda.title', 'Chairwoman, AFRHEEC Board of Directors')}</h3>
          
          <p className="story-text">
            {t('story.frieda.bio1', 'Frieda Bikele is a lifelong advocate for equity, inclusion, and social justice, bringing over 20 years of leadership experience across government agencies, international diplomacy, and nonprofit sectors in both Cameroon and the United States. She currently serves as a Service Equity Manager within a government agency, where she leads efforts to dismantle systemic inequities and build inclusive policies that serve diverse and historically marginalized communities.')}
          </p>

          <p className="story-text">
            {t('story.frieda.bio2', 'Fluent in French, Pidgin English, and several African native languages, Frieda\'s global perspective is matched by her deep community roots. She holds a Bachelor\'s degree in Sociology and Communication, as well as dual Master\'s degrees—one in Socio-Anthropology of Health and another in International Studies with a concentration in Public Health Policy. Her academic background, paired with her lived experience as a woman of African descent navigating multiple systems, fuels her powerful and personal approach to advocacy.')}
          </p>

          <p className="story-text">
            {t('story.frieda.bio3', 'As Chairwoman of AFRHEEC, Frieda leads with empathy and clarity of purpose. She is committed to advancing culturally grounded programs that support refugee, immigrant, and African heritage communities—particularly youth and families navigating educational and systemic barriers. Her passion for community connection shows in her outreach work, which includes linking underserved populations to critical resources and uplifting the voices of refugees and asylum seekers.')}
          </p>

          <p className="story-text">
            {t('story.frieda.bio4', 'Raised in Douala, Cameroon and inspired by her mother\'s resilience, Frieda\'s leadership is rooted in values of compassion, justice, and collective empowerment. She envisions a world where every child—regardless of their background—can thrive in systems that honor their identity and potential.')}
          </p>

          <p className="story-text">
            {t('story.frieda.bio5', 'In her free time, Frieda enjoys trail running, backpacking, and building deep connections within her community. She is especially energized by mentoring the next generation and encouraging young leaders to rise together in solidarity and service.')}
          </p>

          <p className="story-text">
            {t('story.frieda.bio6', 'For Frieda, leadership is not just about direction—it\'s about transformation. Her work continues to shape more equitable pathways for those who have been excluded for too long, always guided by a vision of a just and inclusive future.')}
          </p>
        </div>

        {/* Li'a Hammonds - Vice Chairwoman */}
        <div className="board-member">
          <h2 className="member-name">{t('story.lia.name', 'Li\'a Hammonds')}</h2>
          <h3 className="member-title">{t('story.lia.title', 'Vice Chairwoman, AFRHEEC Board of Directors')}</h3>
